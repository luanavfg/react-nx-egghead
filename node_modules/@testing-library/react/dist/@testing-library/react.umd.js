	...
	function waitFor(callback, _ref) {
	  ...
	  return new Promise( /*#__PURE__*/function () {
	    var _ref2 = _asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee(resolve, reject) {
	      var lastError, intervalId, observer, finished, overallTimeoutTimer, usingFakeTimers, _getWindowFromNode, MutationObserver, onDone, checkCallback, onTimeout;
	        ...
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              ...
	              finished = false;
	              overallTimeoutTimer = setTimeoutFn(onTimeout, timeout);
