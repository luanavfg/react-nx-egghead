...
exports.NUMBER_OF_AXIOS_RETRIES = (0, distributed_task_execution_detection_1.isDistributedExecutionEnabled)(undefined) ||
    exports.AGENT_RUNNING_IN_DISTRIBUTED_EXECUTION ||
    (0, is_ci_1.isCI)()
    ? 10
    : 1;
...
function getNxCacheDirectory(options) {
    if (process.env.NX_CACHE_DIRECTORY)
        return process.env.NX_CACHE_DIRECTORY;
    if (options.cacheDirectory)
        return options.cacheDirectory;
    return exports.NX_DEFAULT_CACHE_LOCATION;
}
exports.getNxCacheDirectory = getNxCacheDirectory;
