...
function run(options, context) {
    ...
    return rxjs_1.from(source_root_1.getSourceRoot(context))
        .pipe(operators_1.concatMap((sourceRoot) => tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        return [
            ...
            web_config_1.getWebConfig(context.workspaceRoot, sourceRoot, options, context.logger, true, isScriptOptimizeOn, context.target.configuration),
            // ES5 build for legacy browsers.
            isScriptOptimizeOn &&
                buildBrowserFeatures.isDifferentialLoadingNeeded()
                ? web_config_1.getWebConfig(context.workspaceRoot, sourceRoot, options, context.logger, false, isScriptOptimizeOn, context.target.configuration)
                : undefined,
        ]
            .filter(Boolean)
