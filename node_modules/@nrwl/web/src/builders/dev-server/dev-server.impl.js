...
function run(serveOptions, context) {
    return rxjs_1.forkJoin(getBuildOptions(serveOptions, context), rxjs_1.from(source_root_1.getSourceRoot(context))).pipe(operators_1.map(([buildOptions, sourceRoot]) => {
