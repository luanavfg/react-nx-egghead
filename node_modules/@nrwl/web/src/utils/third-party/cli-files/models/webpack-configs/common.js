...
exports.getCommonConfig = exports.GLOBAL_DEFS_FOR_TERSER_WITH_AOT = exports.GLOBAL_DEFS_FOR_TERSER = void 0;
/**
 * @license
...
function getCommonConfig(wco) {
    ...
    const extraPlugins = [];
    const entryPoints = {};
    const targetInFileName = utils_2.getEsVersionForFileName(utils_1.fullDifferential
        ? buildOptions.scriptTargetOverride
        : tsConfig.options.target, buildOptions.esVersionInFileName);
    ...
    if (wco.buildOptions.platform !== 'server') {
        ...
        if ((buildOptions.scriptTargetOverride || tsConfig.options.target) ===
            ...
            if (buildOptions.es5BrowserSupport ||
                ...
                const polyfillsChunkName = utils_1.fullDifferential && differentialLoadingNeeded
                    ? 'polyfills'
                    : 'polyfills-es5';
    ...
    if (scriptsOptimization) {
        ...
        if (exports.GLOBAL_DEFS_FOR_TERSER) {
            angularGlobalDefinitions = exports.GLOBAL_DEFS_FOR_TERSER;
        }
        if (buildOptions.aot) {
            // Also try to load AOT-only global definitions.
            if (exports.GLOBAL_DEFS_FOR_TERSER_WITH_AOT) {
                angularGlobalDefinitions = Object.assign(Object.assign({}, angularGlobalDefinitions), exports.GLOBAL_DEFS_FOR_TERSER_WITH_AOT);
            }
        }
        ...
        const terserOptions = {
            ...
            mangle: !mangle_options_1.manglingDisabled &&
                ...
                (!differentialLoadingNeeded ||
                    (differentialLoadingNeeded && utils_1.fullDifferential)),
        };
        ...
        new TerserPlugin({
            ...
            cache: true,
            chunkFilter: (chunk) => globalScriptsByBundleName.some((s) => s.bundleName === chunk.name),
            terserOptions: Object.assign(Object.assign({}, terserOptions), { compress: Object.assign(Object.assign({}, terserOptions.compress), { ecma: 5 }), output: Object.assign(Object.assign({}, terserOptions.output), { ecma: 5 }), mangle: !mangle_options_1.manglingDisabled && buildOptions.platform !== 'server' }),
        }));
    }
    return {
        ...
        module: {
            ...
            rules: [
                ...
                Object.assign({ test: /\.js$/, 
                    ...
                    exclude: /(ngfactory|ngstyle)\.js$/ }, buildOptimizerUseRule),
